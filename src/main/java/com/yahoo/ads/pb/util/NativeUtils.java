...
public class NativeUtils {
	 ...
	 *             than three characters (restriction of {@see
	...
	public static void loadLibraryFromJar(String path) throws IOException {
		...
		logger.debug("Temporary file name of shared object: " + temp.getAbsolutePath());
		...
		try {
			...
			logger.info("Unable to load shared file: {}", e);
		}
		logger.debug("Successfully loaded shared object: " + temp.getAbsolutePath());
	}

	public static String loadTextFromJar(String path) throws IOException {
		if (!path.startsWith("/")) {
			throw new IllegalArgumentException("The path has to be absolute (start with '/').");
		}
